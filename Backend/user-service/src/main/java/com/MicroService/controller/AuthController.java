...
import com.MicroService.playload.request.LoginDto;
import com.MicroService.playload.request.SignupDto;
import com.MicroService.playload.response.ApiResponse;
import com.MicroService.playload.response.ApiResponseBody;
    ...
    public ResponseEntity<ApiResponse> HomeControllerHandler() {
        ...
        return ResponseEntity.status(
                ...
                .body(new ApiResponse(
                        ...
                        "welcome to Mohit property booking system, user api"
